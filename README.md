...
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:khaledhawil@outlook.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/khaledhawil)
...
DevOps Engineer with **1+ year** of hands-on experience in system administration, cloud infrastructure, and automation. Proven expertise in designing and implementing scalable, highly available architectures using **AWS**, **Kubernetes**, and **Infrastructure as Code**. Skilled in optimizing CI/CD pipelines, container orchestration, and GitOps-driven workflows across production environments.

<div align="center">

| Core Competency | Technologies |
|:---:|:---:|
| ![Cloud](https://img.shields.io/badge/Cloud_Architecture-FF9900?style=flat-square&logo=amazon-aws&logoColor=white) | AWS, DigitalOcean, Multi-cloud Solutions |
| ![Container](https://img.shields.io/badge/Container_Orchestration-326CE5?style=flat-square&logo=kubernetes&logoColor=white) | Kubernetes (Kubeadm, EKS, RKE2, Kind), Docker |
| ![HA](https://img.shields.io/badge/High_Availability-28A745?style=flat-square&logo=statuspage&logoColor=white) | HAProxy, Keepalived, 99.9% Uptime |
| ![CICD](https://img.shields.io/badge/CI/CD_Automation-D24939?style=flat-square&logo=jenkins&logoColor=white) | Jenkins, GitHub Actions, GitLab CI, ArgoCD, Flux |
| ![IaC](https://img.shields.io/badge/Infrastructure_as_Code-7B42BC?style=flat-square&logo=terraform&logoColor=white) | Terraform, Ansible |
| ![Database](https://img.shields.io/badge/Database_Management-47A248?style=flat-square&logo=mongodb&logoColor=white) | MongoDB Replica Sets, Redis Clusters, MySQL |
...
### ![Company](https://img.shields.io/badge/DIGINATION-2563EB?style=flat-square&logo=building&logoColor=white) System Administrator & DevOps Engineer
**Oct 2025 – Present**

- Managed virtualized environments on **Proxmox** with VMs and containers for production workloads
- Deployed containerized applications with **Docker** and **Kubernetes** including scaling and orchestration
- Configured **OPNsense** firewalls, VPNs, and network policies to secure enterprise systems
- Automated deployments and CI/CD pipelines using **GitHub Actions** and **Bash** scripting
- Administered **Linux** and **Windows** servers ensuring stability, performance, and security
- Applied networking concepts (TCP/IP, DNS, firewalls, load balancers, SMTP) to support enterprise systems

### ![Company](https://img.shields.io/badge/AlKhawarizmi.ai-7C3AED?style=flat-square&logo=robot&logoColor=white) System Administrator & DevOps Engineer
**Dec 2024 – Nov 2025**

- Built and managed single/multi-node **Kubernetes** clusters using Kubeadm and EKS
- Implemented containerization solutions with Docker, reducing developer setup time by **60%**
- Scaled workloads achieving **99.9% uptime** through monitoring and troubleshooting
- Configured and maintained **MongoDB** replica sets and **Redis** clusters for data redundancy
- Conducted root cause analysis (RCA) and documented incident reports
- Managed cloud platforms ensuring high availability and scalability
...
### Task Management System – End-to-End DevOps & GitOps Pipeline

![STATUS](https://img.shields.io/badge/STATUS-PRODUCTION_READY-28A745?style=for-the-badge&logoColor=white)

Production-ready microservices application on Kubernetes with complete GitOps automation

**Technology Stack:**

![Kubernetes](https://img.shields.io/badge/RKE2-326CE5?style=flat&logo=kubernetes&logoColor=white)
![Flux](https://img.shields.io/badge/Flux_CD-5468FF?style=flat&logo=flux&logoColor=white)
![Weave GitOps](https://img.shields.io/badge/Weave_GitOps-00D9FF?style=flat&logo=weaveworks&logoColor=white)
...
### ITI Final Project – Full DevOps on AWS (MERN Stack)

![STATUS](https://img.shields.io/badge/STATUS-PRODUCTION_READY-28A745?style=for-the-badge&logoColor=white)

Enterprise-grade MERN stack e-commerce platform with complete DevOps automation on AWS
...
### Weather App – CI/CD with GitHub Actions & ArgoCD

![STATUS](https://img.shields.io/badge/STATUS-PRODUCTION_DEPLOYED-28A745?style=for-the-badge&logoColor=white)

Cloud-native microservices weather application with complete CI/CD and GitOps automation
...
### Islamic App – Full DevOps Deployment (React/Flask)

![STATUS](https://img.shields.io/badge/STATUS-FULLY_DEPLOYED-28A745?style=for-the-badge&logoColor=white)

React and Flask full-stack application with Kubernetes deployment and Jenkins CI/CD
...
![Culture](https://img.shields.io/badge/Culture-Collaboration_over_Silos-DC2626?style=flat-square&logo=handshake&logoColor=white)
![Automation](https://img.shields.io/badge/Automation-Efficiency_over_Manual_Work-2563EB?style=flat-square&logo=gear&logoColor=white)
![Measurement](https://img.shields.io/badge/Measurement-Data_over_Assumptions-28A745?style=flat-square&logo=chart-line&logoColor=white)
![Sharing](https://img.shields.io/badge/Sharing-Knowledge_over_Hoarding-FF6B35?style=flat-square&logo=share&logoColor=white)
...
![Automation](https://img.shields.io/badge/Automation-Reduce_Manual_Work-2563EB?style=for-the-badge&logo=robot&logoColor=white)
...
![Monitoring](https://img.shields.io/badge/Monitoring-Observe_Everything-28A745?style=for-the-badge&logo=grafana&logoColor=white)
...
![Learning](https://img.shields.io/badge/Learning-Never_Stop-FF6B35?style=for-the-badge&logo=book&logoColor=white)
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=200&section=footer&text=Thank%20You%20for%20Visiting!&fontSize=40&fontColor=fff&animation=twinkling&fontAlignY=65" alt="Footer" width="100%"/>
</div>
</div>
